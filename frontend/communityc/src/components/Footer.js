    ...
    <footer className="bg-gray-800 text-white text-center py-6">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-4">
          ...
          <p className="text-sm">
            Email: <a href="mailto:support@serviceprovider.com" className="hover:text-gray-400">bookings.communityc@gmail.com</a><br />
        ...
        <div className="mb-4">
          ...
          <div className="flex justify-center space-x-4 mt-2">
            ...
            <a href="https://www.linkedin.com/company/communitycrafters-marketplace" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400">LinkedIn</a>
          </div>
        </div>
        <div className="mt-4">
          <a href="/terms" className="hover:text-gray-400">Privacy Policy</a>
